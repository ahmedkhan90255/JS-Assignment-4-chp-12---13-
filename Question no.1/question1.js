document.write(
  "<h1> Write a program that takes a character (number or string) <br> in a variable & checks whether the given input is a <br> number, uppercase letter or lower case letter. (Hint: ASCII  <br> codes:- A=65, Z=90, a=97, z=122). </h1>"
);

alert(
  "Input anything I will tell you whether it is Number, Letter ( Uppercase or Lowercase)"
);
