...
alert(
  "Enter time like : if the time is: 1pm, Enters it like = 1300, 5pm = 1700 Whatever the time is enters like this I will give you the response according to your time"
);
